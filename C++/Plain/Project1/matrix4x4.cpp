...
void Matrix4x4::loadRotationMatrix(Vector3D &p, Vector3D &v, double alpha)
{
...
ostream& operator<< (ostream& out, const Matrix4x4 &a)
{
	for (int i = 0; i < 4; i++)
	{
		for (int j = 0; j < 4; j++)
