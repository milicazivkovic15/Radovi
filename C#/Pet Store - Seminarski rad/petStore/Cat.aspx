...
<body>
    ...
    <div  class="content">
        ...
        <div class="pet_div1">
            ...
            <tr>
                <td><asp:Button ID="dodaj" runat="server" Text="Add cat" OnClick="dodaj_Click"/></td>
             ...
             <tr>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" TableName="cats"></asp:LinqDataSource></td>
             </tr>
             <tr>
