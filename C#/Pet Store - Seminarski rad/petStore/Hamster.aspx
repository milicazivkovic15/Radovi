<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Hamster.aspx.cs" Inherits="Hamster" %>
...
<body>
    <form id="form1" runat="server">
     <div  class="content">
          ...
          <div class="pet_div">
         <a href="Pet.aspx"><img class="img1" src="Images/dog.png" width="230" height="230" /></a>
        ...
        <div class="pet_div1">
            ...
            <tr>
                ...
                <asp:LinqDataSource ID="LinqDataSource2" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" TableName="owners"></asp:LinqDataSource></td>
           </tr>
            <tr>
            ...
            <tr>
                <td><asp:Button ID="dodaj" runat="server" Text="Add hamster" OnClick="dodaj_Click"/></td>
             ...
             <tr>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" TableName="hamsters"></asp:LinqDataSource></td>
             </tr>
                 <tr>
            ...
            <tr>
                ...
                <td><asp:Button ID="obrisi" runat="server" Text="Remove pat" OnClick="obrisi_Click"/></td>
            </tr>
