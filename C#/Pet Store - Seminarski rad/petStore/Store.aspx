...
<body>
    ...
    <div class="content">
        ...
        <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" TableName="stores"></asp:LinqDataSource>
         ...
         <table class="tabela">
            ...
            <tr>
                ...
                <asp:LinqDataSource ID="LinqDataSource3" runat="server" ContextTypeName="DataClassesDataContext" EntityTypeName="" TableName="pets"></asp:LinqDataSource></td>
            </tr>
            <tr>
