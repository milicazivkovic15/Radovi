<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cat.aspx.cs" Inherits="Pet_Store.Cat" %>
        ...
        <div class="pet_div1">
            ...
            <tr>
             ...
             <tr>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Pet_Store.DataClasses1DataContext" EntityTypeName="" TableName="cats"></asp:LinqDataSource></td>
             </tr>
             <tr>
