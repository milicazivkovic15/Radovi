<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Hamster.aspx.cs" Inherits="Pet_Store.Hamster" %>
        ...
        <div class="pet_div1">
            ...
            <tr>
             ...
             <tr>
                ...
                <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="Pet_Store.DataClasses1DataContext" EntityTypeName="" TableName="hamsters"></asp:LinqDataSource></td>
             </tr>
                 <tr>
